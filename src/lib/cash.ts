...
// Current month as a Prisma date filter { gte, lte }, aligned to business days:
// it runs from the start of the 1st's business day to the end of the last day's
// business day. This keeps the trading night that straddles each month boundary
// attributed to the correct month (a 00:30 sale on the 1st counts toward the
// previous month, where its business day began). Pass the configured hours so
// the alignment matches the rest of the app.
